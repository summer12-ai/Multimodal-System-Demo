...
class UnifiedResultHub:
    ...
    def append_traffic(self, traffic_snapshot: Dict[str, Any]):
        payload = {"timestamp": self._now(), "type": "traffic", "data": traffic_snapshot}
        self._write_jsonl(self.traffic_jsonl, payload)

    def append_ground_truth(self, eval_result: Dict[str, Any]):
        ...
        self.fusion_csv.writerow(
            {
                ...
                "traffic_state": fusion.get("traffic_state", ""),
                "traffic_confidence": fusion.get("traffic_confidence", 0.0),
