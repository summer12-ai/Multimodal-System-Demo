...
def parse_args():
    ...
    parser.add_argument("--disable-traffic", action="store_true", help="关闭 Traffic 流量子模块（默认开启）")
...
def main():
    ...
    proj_cfg = ProjectConfig(
        ...
        enable_traffic=not args.disable_traffic,
    ...
    orch_cfg = OrchestratorConfig(
        ...
        enable_traffic=proj_cfg.enable_traffic,
